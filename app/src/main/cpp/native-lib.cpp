...
Java_com_yxk_aaudiotest_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_yxk_aaudiotest_MainActivity_nativeCreateAAudioEngine(JNIEnv *env, jobject thiz,
...
Java_com_yxk_aaudiotest_MainActivity_nativeDestroyAAudioEngine(JNIEnv *env, jobject thiz,
                                                               jlong engine_handle) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_yxk_aaudiotest_MainActivity_nativeAAudioEnginePlay(JNIEnv *env, jobject thiz,
                                                            jlong engine_handle) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_yxk_aaudiotest_MainActivity_nativeAAudioEnginePause(JNIEnv *env, jobject thiz,
                                                             jlong engine_handle) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_yxk_aaudiotest_MainActivity_nativeAAudioEngineStop(JNIEnv *env, jobject thiz,
                                                            jlong engine_handle) {
